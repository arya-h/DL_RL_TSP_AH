...
def argparser():
	...
	parser.add_argument('-t', '--city_t', metavar = 'T', type = int, default = 50, help = 'number of cities(nodes), time sequence, default: 20')
...
class Config():
	def __init__(self, **kwargs):	
		...
		self.log_step = 1
		self.lr = 0.001 #1e-3
		self.lr_decay = 0.9999999
		self.lr_decay_step = 11e3
		...
		self.log_dir = "./log/"
		self.act_model_path = "./model/second_train.pt"
